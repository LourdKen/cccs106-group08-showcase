...
def get_initial_team() -> List[TeamMember]:
    ...
    members = [
        ...
        # ----------------------------------------------------------------------
        TeamMember(
            student_id="2410994",  # example: "2024-10456"
            full_name="Laurence Echipare", # example: "Juan Dela Cruz"
            role="Backend & State Engineer",
            specialization="State Mutation & Event Handlers",
            github_handle="@LorensDotDocx-github",          # example: "@jdelacruz-cspc"
            avatar_icon=ft.Icons.DATA_OBJECT,
            accent_color=ft.Colors.AMBER_800,
            photo_url="https://github.com/LorensDotdocx.png",                 # Photo: local asset or URL (e.g. "https://github.com/dev2-github.png")
        ),
        # ----------------------------------------------------------------------
        ...
        TeamMember(
            ...
            photo_url="https://avatars.githubusercontent.com/u/258713631?v=4",                 # Photo: local asset or URL (e.g. "https://github.com/dev3-github.png")
        ),
    ]
    return members
